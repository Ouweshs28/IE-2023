            ...
            <div class="header-wrapper">
                <div class="site-branding-social">
                    <div class="site-branding">
                        <?php
                        the_custom_logo(); ?>
                        <?php $siteTitleShow = get_theme_mod('virtual_conference_site_title', true);
                        ...
                        <?php } ?>
                        <?php
                        $siteDescShow = get_theme_mod('virtual_conference_tagline', false);
                        if($siteDescShow){
                ...
                <button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><!-- <?php esc_html_e( 'Primary Menu', 'virtual-conference' ); ?> -->
                    <div id="nav-icon">
                        <span></span>
                        <span></span>
                        <span></span>
