...
if ( ! class_exists( 'Virtual_Conference_Slider_Control' ) ) {

	/**
	/**
	 * Slider control (range).
	 */
	class Virtual_Conference_Slider_Control extends Wp_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'virtual-conference-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'virtual-conference-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
